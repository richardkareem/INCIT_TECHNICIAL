...
// import { getAllDataExpenseUsers, getAllExpenseByEmail } from '../../services/expene.service';
...
// export const deleteExpensesByEmail = (email: string, data: any, onSuccess: ()=> void):AppThunk => async(dispatch) =>{
//     try {
